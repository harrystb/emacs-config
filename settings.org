...
** Remove splash screen, menu bar  and echo area on startup
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key hb-file-map "f" '("Find file" . helm-find-file))
...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    (evil-define-key 'normal 'global (kbd "<leader>h") (cons "Help Commands" help-map))
    (evil-define-key 'normal 'global (kbd "<leader>p") '("Projectile commands" . projectile-command-map))
    (evil-define-key 'normal 'global (kbd "<leader>b") (cons "Buffer commands" hb-buffer-map))
    (evil-define-key 'normal 'global (kbd "<leader>f") (cons "File commands" hb-file-map))
    (evil-define-key 'normal 'global (kbd "<leader>e") (cons "Evaluate commands" hb-eval-map))
    (evil-define-key 'normal 'global (kbd "<leader>m") (cons "Harpoon commands" hb-harpoon-map))
    (evil-define-key 'normal 'global (kbd "<leader>o") (cons "Org commands" hb-org-map))
